...
public interface HospitalRepository extends JpaRepository<Hospital, Integer>{
	...
	@Query(value="select * from Hospitals a, \r\n" + 
			...
			") AS distance FROM Hospitals where availableambulance <> 0 and ( AvailableOxygenUnit <> 0 or availableventilator <> 0 or availableicu <> 0) ORDER BY distance LIMIT 3) b where a.hospitalId = b.hospitalId",nativeQuery=true)
	...
	@Query(value="select * from Hospitals a, \r\n" + 
			" (SELECT hospitalId,( 3959 * acos(cos(radians(37)) * cos(radians(lattitude)) * cos(radians(longitude) - radians(:patLongitude)) + sin(radians(:patLatitude)) * sin(radians(lattitude )))\r\n" + 
			") AS distance FROM Hospitals where availableambulance <> 0 and availableisolationbed <> 0 ORDER BY distance LIMIT 3) b where a.hospitalId = b.hospitalId",nativeQuery=true)
	...
	@Query(value="select * from Hospitals a, \r\n" + 
			" (SELECT hospitalId,( 3959 * acos(cos(radians(37)) * cos(radians(lattitude)) * cos(radians(longitude) - radians(:patLongitude)) + sin(radians(:patLatitude)) * sin(radians(lattitude )))\r\n" + 
			") AS distance FROM Hospitals where   AvailableOxygenUnit <> 0 or availableventilator <> 0 or availableicu <> 0 ORDER BY distance LIMIT 3) b where a.hospitalId = b.hospitalId",nativeQuery=true)
	...
	@Query(value="select * from Hospitals a, \r\n" + 
			" (SELECT hospitalId,( 3959 * acos(cos(radians(37)) * cos(radians(lattitude)) * cos(radians(longitude) - radians(:patLongitude)) + sin(radians(:patLatitude)) * sin(radians(lattitude )))\r\n" + 
			") AS distance FROM Hospitals where  availableisolationbed <> 0 ORDER BY distance LIMIT 3) b where a.hospitalId = b.hospitalId",nativeQuery=true)
